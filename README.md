...
Copy the Command: Highlight and copy your specific PowerShell stub code.

Paste and Run: Right-click in the PowerShell window to paste the command, then press Enter.

View Results: The utility will pull the latest version from Pastebin and display your system audit instantly.
